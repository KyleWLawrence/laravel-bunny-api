...
namespace KyleWLawrence\Bunny\Http;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\HandlerStack;
use KyleWLawrence\Bunny\Exceptions\AuthException;
use KyleWLawrence\Bunny\Http\Middleware\RetryHandler;
use KyleWLawrence\Bunny\Http\Resources\Send;
use KyleWLawrence\Bunny\Utilities\Auth;
...
class HttpClient
{
    ...
    public function __construct(
        protected string $hostname = 'api.bunny.net',
    ...
    {
        return 'Bunny API PHP '.self::VERSION;
    }
     ...
     *
     * @throws \KyleWLawrence\Bunny\Http\Exceptions\AuthException
     * @throws \KyleWLawrence\Bunny\Http\Exceptions\ApiResponseException
     */
